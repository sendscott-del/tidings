      ...
      <div className="px-4 -mt-12 pb-10">
        <form onSubmit={handleSubmit} className="max-w-sm mx-auto bg-white rounded-md shadow-lg p-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-2.5 bg-tidings-chrome hover:bg-yellow-800 text-white font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
          >
