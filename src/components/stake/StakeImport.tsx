    ...
    <div className="max-w-2xl">
      ...
      {stage === 'upload' && (
        ...
        >
          ...
          <p className="text-slate-700 font-medium mb-1">Drop your LCR CSV or PDF export here</p>
          <p className="text-slate-500 text-sm mb-4">or click to browse</p>
          <label className="inline-block px-4 py-2 bg-tidings-chrome text-white text-sm font-medium rounded-lg cursor-pointer hover:bg-yellow-800 transition-colors">
            Choose File
            <input type="file" accept=".csv,.pdf" onChange={handleFileInput} className="hidden" />
          </label>
        </div>
      )}
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="px-5 py-2.5 bg-tidings-chrome text-white text-sm font-medium rounded-lg hover:bg-yellow-800 transition-colors"
            >
              Confirm Import
            </button>
            <button
